from .elementcontainer import ElementContainerAbc, RelativeDimensions, RelativeElementAbc, RelativeElementDescription, RelativeOffsetCoord

class UiRect(RelativeElementAbc):
    
    def __init__(self, top_left_offset, relative_dimensions, styles = None):
    """
